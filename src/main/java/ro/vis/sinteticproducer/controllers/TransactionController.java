...
public class TransactionController {
    ...
    @GetMapping("/input")
    public ResponseEntity<String> mockCommand() {
        return transactionService.sendTransaction() ? ResponseEntity.ok("Message Sent!") : ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("Failed to send message");
    }
}
